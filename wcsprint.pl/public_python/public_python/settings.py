...
SECRET_KEY = '0rt@jro^vx47%f)ky(ko@=o-hsug4-59_z*iw+3+d7cg2r7*l@'

# SECURITY WARNING: don't run with debug turned on in production!

ALLOWED_HOSTS = ['wcsprint.pl','www.wcsprint.pl', 'localhost', '127.0.0.1']
...
EMAIL_USE_TLS = True
EMAIL_PORT = 465
EMAIL_HOST_USER = 'wcserwis@wp.pl'
EMAIL_HOST_PASSWORD = '/p&P9pUjSBs45+M'
